...
import {
    ...
    Modal, ModalBody, ModalHeader, Button, FormGroup, Input, Form, Label
} from 'reactstrap';
...
class Header extends Component {
    ...
    render() {
        return (
            // * This Empty signs are equivalent to <React.Fragment>...<React.Fragment/>
            // ? By Doing this, you do not add extra node in DOM
            <>
